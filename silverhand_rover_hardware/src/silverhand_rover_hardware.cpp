#include "silverhand_rover_hardware/silverhand_rover_hardware.hpp"
  ...
  const std::uint16_t default_value)
{
  ...
  try {
    ...
    RCLCPP_WARN(
      rclcpp::get_logger("silverhand_rover_hardware"),
...
PLUGINLIB_EXPORT_CLASS(
  silverhand_rover_hardware::SilverhandRoverSystem,
